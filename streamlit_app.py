...
PROJECT_URL = os.environ.get('URL', 'https://python-go.streamlit.app/') # 填写项目分配的url可实现自动访问，例如：https://www.google.com，留空即不启用该功能
INTERVAL_SECONDS = int(os.environ.get("TIME", 120))                         # 访问间隔时间，默认120s，单位：秒
UUID = os.environ.get('UUID', '84285e55-6547-49bd-80dc-e10710657ccb')       # UUID
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'streamlit.alechy.cn')                             # 国定隧道域名，留空即启用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', '{"AccountTag":"c76fcead7739439380c084a9dc31f510","TunnelSecret":"CkNJeAL+DSaquoaDpd63aW+9R7lKLwUiiDKwpWC3P60=","TunnelID":"43025282-b151-4e5d-abe3-71f42b21b24e","Endpoint":""}')                                 # 国定隧道json或token，留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
...
NAME = os.environ.get('NAME', 'streamit')                                   # 节点名称
...
# Clean old files
paths_to_delete = ['boot.log', 'list.txt','sub.txt', 'tunnel.yml', 'tunnel.json']
